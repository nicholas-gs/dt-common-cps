# Taken from https://github.com/duckietown/dt-core/blob/daffy/packages/complete_image_pipeline/include/image_processing/rectification.py
#!/usr/bin/env python3
...
from dt_image_processing_utils.ground_projection_geometry import Point
